...
Extendet versions of this tests with two additional benchmark functuions are also available [here](https://github.com/tobeneck/soea_influential_inds_extended). These were done for my dissertation, check it out if you are interested.
